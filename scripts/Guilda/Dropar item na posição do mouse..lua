...
"    height: 22\n"
-- =============================================================================
-- [BLOCO 3] DESIGN DO POP-UP SEGURO (MÉTODO DA FUGA QUE DEVOLVE O FOCO)
-- =============================================================================
...
function updateDropUI() end

-- =============================================================================
-- [BLOCO EXTRA] BOTÕES DO MENU LATERAL COMPACTO NATIVO
-- =============================================================================
...
-- Função de abertura do Pop-up declarada de forma local/universal segura
...
local function updateMenuButtonsVisual()
    ...
    modules.dropMenuUI.btnMouse:setColor(storage.dropSettings.enabledMouse and "green" or "red")
    modules.dropMenuUI.btnChao:setColor(storage.dropSettings.enabledChao and "green" or "red")
end
...
macro(100, function()
    ...
    if dropWindow and dropWindow:isVisible() and dropWindow.lblMarcaDaguaUniversal then
        ...
        dropWindow.lblMarcaDaguaUniversal:setColor(string.format("#%02X%02X%02X", tomDeCinza, tomDeCinza, tomDeCinza))
    end
end)
