...
-- =============================================================================
local ANUNCIO_TITULO = "ATUALIZACAO NO MW no PE! Testem e me falem se ta tudo ok"
local ANUNCIO_TEXTO  = "Sobre os macros de Pushe, estou tramalhando neles em breve lanço eles.."
