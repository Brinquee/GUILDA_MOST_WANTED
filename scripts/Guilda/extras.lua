...
if true then
  ...
  onAddThing(function(tile, thing)
    ...
    local timer = 0
    if thing:getId() == 2128 or thing:getId() == 37577 then -- mwall id
  ...
  onRemoveThing(function(tile, thing)
    ...
    if (thing:getId() == 2128 or thing:getId() == 27577 or thing:getId() == 2130) and tile:getGround() then
      local pos = tile:getPosition().x .. "," .. tile:getPosition().y .. "," .. tile:getPosition().z
...
if true then
  ...
  onRemoveThing(function(tile, thing)
    if not settings.holdMwall then return end
      ...
      if thing:getId() ~= 37577 then return end
